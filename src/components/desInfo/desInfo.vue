      ...
      <div class="warrper">
        ...
        <div class="city-info__title">
          <div class="city-info__img">
            <img :src="infos.cityPic" alt="图片">
            <h2 class="title">{{infos.city}}</h2>
          </div>
          <div class="city-info__guide">
            <h3 class="h2title">旅游攻略</h3>
            <p class="intro">{{infos.info}}</p>
          </div>
        </div>
        <div class="style"></div>
        <!-- 热门景点 -->
        <div class="city-info__hot">
          ...
          <div class="city-info-title">
            <ul class="hotmenu">
              <li class="hot-spot" v-for="(hot,index) in infos.hotPicList" :key="index">
                <div class="hot-spot-part">
                  <img :src="hot" title="图片" class="img">
                  <p class="spot-name">{{infos[`hotTitle${index+1}`]}}</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="city-info__hot">
          ...
          <div class="city-info-title" ref="picWrapper">
            <ul class="hotmenu" ref="ulWidth">
              <li class="hot-spot" v-for="(food,index) in infos.foodPicList" :key="index">
                <div class="hot-spot-part">
                  <img :src="food" title="图片" class="img">
                  <p class="spot-name">{{infos[`foodTitle${index+1}`]}}</p>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="goods_menu">
          ...
          <ul>
            <li class="goods__list-li" v-for="(item,index) in infos.goPicList" :key="index">
              <div class="goods__list-pics">
                <!-- 蒙层 -->
                <div class="goods__mosk"></div>
                <img :src="item" class="list-pics__img">
              </div>
              <div class="goods__list-detail">
                <h2 class="goods__list-title">{{infos[`goTitle${index+1}`]}}</h2>
