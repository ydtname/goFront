  ...
  <div class="slide-show" @touchstart="clearRun" @touchend="run">
    <div class="slide-show__img">
      <transition name="slide-trans">
        <img :src="pics[nowIndex].src" v-show="show">
      </transition>
    ...
    <ul class="slide-show__ul">
      <li v-for="(item,index) in pics" class="slide-show__li" @click="goto(index)" :class="{'on':index===nowIndex}" :key="index">
      </li>
    </ul>
  </div>
</template>
<script type="text/javascript">
import img from '../../../static/json/json'
export default {
  data() {
    return {
      pics:   img.images,
