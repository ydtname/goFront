  ...
  <div class="header-warrper">
    <div class="header">
      ...
      <div class="header__logo">
        <img src="../../assets/images/go.png" class="header__img" title="图片">
      </div>
      <!-- 导航折叠 -->
    ...
    <transition name="fadeLeft">
      <div class="mosk" v-show="showMosk">
        ...
        <div class="mosk__footer">
          <!-- 已登录 -->
          <div class="mosk__footer-pic">
            <img :src="seller.pic" title="图片">
            <p class="mosk__footer-login">欢迎回来，{{seller.account}}。</p>
    ...
    <transition name="fade-x">
      <login v-show="this.$store.state.loginVisible" :loginInfo="seller" @closeLogin="closeLogin" @closeL="closeL"></login>
    </transition>
  </div>
</template>
